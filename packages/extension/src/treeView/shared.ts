...
const MUI_ICON_MAP: Partial<Record<ResourceNodeType, string>> = {
  ...
  'resource-type': 'category.svg',
  'cluster-resource-type': 'category.svg',
  trait: 'extension.svg',
...
const THEME_ICON_MAP: Record<ResourceNodeType, string> = {
  // Resource view — custom font icons where available
  namespace: 'openchoreo-apartment',
  project: 'openchoreo-dashboard',
  component: 'openchoreo-memory',
  ...
  'data-plane': 'openchoreo-dns',
  'workflow-plane': 'openchoreo-build',
  'observability-plane': 'openchoreo-visibility',
  'component-type': 'openchoreo-category',
  'resource-type': 'openchoreo-category',
  workflow: 'openchoreo-play-circle-outline',
  trait: 'openchoreo-extension',
  'secret-reference': 'key',
  'namespace-role': 'openchoreo-security',
  'namespace-role-binding': 'openchoreo-link',
  'cluster-role': 'openchoreo-security',
  'cluster-role-binding': 'openchoreo-link',
  // Infrastructure view (cluster-scoped)
  'cluster-component-type': 'openchoreo-category',
  'cluster-resource-type': 'openchoreo-category',
  'cluster-workflow': 'openchoreo-play-circle-outline',
  'cluster-trait': 'openchoreo-extension',
  'cluster-data-plane': 'openchoreo-dns',
  'cluster-workflow-plane': 'openchoreo-build',
  'cluster-observability-plane': 'openchoreo-visibility',
